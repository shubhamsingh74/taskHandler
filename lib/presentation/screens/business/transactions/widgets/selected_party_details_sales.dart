...
class SelectedPartyDetailsSales extends StatelessWidget {
  const SelectedPartyDetailsSales(
      {super.key,
      
      required this.partyDetail,
      required this.transactionInvoiceBloc});
  final PartiesListDatum? partyDetail;
  final TransactionSalesInvoiceBloc transactionInvoiceBloc;
  @override
            ...
            trailing: CloseButton(
              onPressed: () {
                transactionInvoiceBloc.add(
                    TransactionSalesInvoiceSelectPartyEvent(partyDetail: null));
              },
