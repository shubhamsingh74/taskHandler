...
class MyRoundCheckBox extends StatefulWidget {
  ...
  @override
  _MyRoundCheckBoxState createState() => _MyRoundCheckBoxState();
}

class _MyRoundCheckBoxState extends State<MyRoundCheckBox> {
  bool? isChecked;
  ...
  @override
  void didUpdateWidget(MyRoundCheckBox oldWidget) {
    uncheckedColor =
