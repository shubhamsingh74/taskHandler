...
class _$ClientFailureImpl implements _ClientFailure {
  const _$ClientFailureImpl({required this.errorMessage});
  ...
  @override
  String toString() {
    return 'MainFailures.clientFailure(errorMessage: $errorMessage)';
  }
...
abstract class _ClientFailure implements MainFailures {
  const factory _ClientFailure({required final String errorMessage}) =
      _$ClientFailureImpl;
...
abstract class _ServerFailure implements MainFailures {
  const factory _ServerFailure({required final String errorMessage}) =
      _$ServerFailureImpl;
